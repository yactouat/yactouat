...
@section('meta')
    @php
        $description = "register to yactouat.com, the developer website and blog of Yacine Touati. All about futurism, problem solving, tech, AI, software engineering, and web development!";
    @endphp
